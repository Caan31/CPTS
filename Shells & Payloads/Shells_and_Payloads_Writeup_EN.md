...
**Official assessment questions:** *"What is the hostname of Host-1?"* and *"Exploit the target and gain a shell session. Submit the name of the folder located in `C:\Shares\`"*.
